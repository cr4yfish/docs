...
<Note>
As of the [September 13, 2026 update](/changelog/overview), the product UI calls this a **Genie App** rather than a "Project". These pages still say "project" — the same thing either way.
</Note>
...
You can also upload files in bulk through the workspace chat. Open the command palette with ⌘K (Mac) or Ctrl+K (Windows), choose **Upload files**, or ask the Genie workspace AI directly. A drag-and-drop card — pick individual files or a whole folder at once — publishes them straight into a chosen project; any file type is accepted, not just images and video.
