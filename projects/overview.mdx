...
On mobile, the Genie AI tab is the primary way to work on a project. The project's own build chat moves to a secondary view, reachable from the Genie AI tab's header — visible to admins only.
