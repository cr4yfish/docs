...
Open the panel's chat switcher to jump between your recent Genie AI conversations for this workspace instead of losing track of one to start another. To begin a brand-new conversation, just start typing in the composer — there's no separate "New chat" button to look for.
