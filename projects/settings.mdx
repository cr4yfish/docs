...
<AccordionGroup>
  ...
  <Accordion title="Brain">
    A read-only view of your project's code structure and build history — see what Genie has built so far and how the pieces fit together. Anyone with access to the project (owner or workspace member) can open this tab.
  </Accordion>
