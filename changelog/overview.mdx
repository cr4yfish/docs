...
Covers what shipped on September 14. A blocked message now reads as a calm notice instead of an error, with an opt-in email alert for admins; Guardrails can check attached images too; the Activity page adds a Security alerts summary and CSV/PDF export; and projects get a personal Favorites shelf.
