...
At the bottom of the Cloud tab, the **Advanced** section contains a **Re-run bootstrap** button. Use this to upgrade an existing project to the latest Genie Cloud version or to recover from an interrupted provisioning. The bootstrap is fully safe to run at any time — it does not delete any data.

<Tip>
  Onboarding and private mode settings sync to your live Cloud instance automatically when you save them. You do not need to run Re-run bootstrap after changing these settings.
</Tip>
