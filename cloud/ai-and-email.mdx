...
<CardGroup cols={2}>
  <Card title="AI text (OpenAI & Anthropic)" icon="sparkles">
    Generate text, summaries, chat replies, and other AI content — and read images or PDFs you give it. Backed by OpenAI or Anthropic's Claude models through Genie.
  </Card>
