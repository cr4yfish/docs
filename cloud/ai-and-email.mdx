...
<Tip>
  Just describe what you want — "summarise each support ticket", "generate a hero image of a sunset over mountains", "change the background of this photo to a beach", "email me when someone submits the form" — and Genie builds the feature using these built-in credentials. You do not need to mention API keys at all.
</Tip>
