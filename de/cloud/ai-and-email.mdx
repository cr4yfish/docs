...
<Tip>
  Beschreibe einfach, was du möchtest — „fasse jedes Support-Ticket zusammen", „erzeuge ein Hero-Bild von einem Sonnenuntergang über Bergen", „ändere den Hintergrund dieses Fotos zu einem Strand", „schick mir eine E-Mail, wenn jemand das Formular absendet" — und Genie baut die Funktion mit diesen eingebauten Zugangsdaten. API-Schlüssel musst du gar nicht erwähnen.
</Tip>
