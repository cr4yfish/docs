...
Jeder Workspace enthält den **Genie AI**-Tab — einen persistenten KI-Assistenten, der auf deinen Workspace zugeschnitten ist. Klicke auf die Schaltfläche **Genie AI** in der Seitenleiste oder öffne ihn von der Workspace-Startseite aus, um ein Gespräch zu beginnen. Du kannst Fragen zu deinen Projekten stellen, Ideen erkunden oder einen früheren Thread fortsetzen.

Gespräche werden automatisch gespeichert und erscheinen beim nächsten Öffnen im Genie AI-Panel. Der Assistent hat Zugriff auf deinen Workspace-Kontext — Projektnamen, aktuelle Aktivitäten, Mitgliederliste — und kann daher Fragen beantworten wie *"Welches meiner Projekte wurde zuletzt aktualisiert?"* oder *"Fasse die Aktivitäten der letzten Woche zusammen."*

<Tip>
Das Genie AI-Panel ist auch von jeder Projektseite aus verfügbar. Nutze es, um Fragen zu stellen, die den gesamten Workspace betreffen, ohne das Projekt zu verlassen, an dem du arbeitest.
</Tip>

## Zusammenarbeit

Wenn mehrere Teammitglieder dasselbe Projekt öffnen, kann nur eine Person gleichzeitig Prompts senden. Genie zeigt ein Banner mit dem Namen des aktiven Editors an und gibt dein Eingabefeld frei, sobald die andere Person fertig ist. Die Übergabe erfolgt automatisch — keine manuellen Schritte erforderlich.

## Verwandte Seiten

- [Workspace-Mitglieder](/de/workspaces/members)
