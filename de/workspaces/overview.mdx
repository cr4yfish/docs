...
Ein Panel **Cloud-Speicher** am Ende der Knowledge-Seite zeigt für jedes Mitglied, wo es mit Google Drive oder Microsoft 365/OneDrive steht — noch nicht verbunden, oder verbunden und bereit zum Durchsuchen. Sobald du dein eigenes Google Drive verbunden hast (siehe [Verfügbare Preset-Integrationen](/de/workspaces/integrations#verfügbare-preset-integrationen)), erscheint es als eigener Ort im Knowledge-Browser: durchsuche das gesamte Laufwerk, öffne Ordner, und klicke bei jeder Datei, die Genie lesen kann (Docs, Sheets, Slides oder ein reiner Text-Upload), auf **In Knowledge importieren**, um eine Kopie als Wissensdokument abzulegen — zitierfähig wie jedes andere.

Über das einzelne Importieren hinaus kannst du auch einen ganzen Drive-Ordner **im Abgleich** halten: Wähle einmal aus der Liste **Synchronisierte Ordner** einen Ordner (oder nur die Unterordner, die du willst), und Genie spiegelt ihn ab dann automatisch in deine Wissensdatenbank — neue und geänderte Dateien werden übernommen, aus der Quelle entfernte Dateien verschwinden auch hier, per **Jetzt synchronisieren** jederzeit auf Wunsch und von allein alle paar Stunden dazwischen.
