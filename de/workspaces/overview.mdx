...
Innerhalb eines Geltungsbereichs lassen sich Dokumente außerdem in **Ordner** einsortieren — eine Ablage-Ebene zum Wiederfinden, getrennt vom Geltungsbereich, der entscheidet, was Genie AI nutzen darf. Ein Ordner „Marke" kann sowohl ein workspaceweites Dokument als auch das eigene Textkonzept eines Projekts enthalten, und ob ein Dokument in einem Ordner liegt oder nicht, ändert nie, was Genie bei einer Suche findet. Lege Ordner über die Chip-Leiste oberhalb der Dokumentliste an, benenne sie um oder lösche sie; jeder fasst bis zu 200 Dokumente, und das Löschen eines Ordners löscht nie, was darin liegt — diese Dokumente werden einfach unabgelegt.
