...
<Tip>
  Bitte sie, ein bestehendes Projekt zu aktualisieren — „sende einen Folge-Prompt an mein Dashboard-Projekt: füge einen Dark-Mode-Schalter hinzu" — oder ein brandneues mit einem Eröffnungs-Prompt zu erstellen, und in beiden Fällen verfolgt eine Live-Status-Karte den Build direkt im Chat (In der Warteschlange → Wird gebaut → Live), mit einem Link, um das Projekt zu öffnen, sobald es fertig ist.
</Tip>
