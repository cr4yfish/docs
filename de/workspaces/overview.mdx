...
Die Workspace-KI kann Projekte erstellen und aktualisieren, Mitglieder verwalten, den Credit-Verbrauch abfragen, Preisfragen beantworten, vergangene Gespräche durchsuchen, prüfen, ob es für einen von dir beschriebenen Fehler bereits eine bekannte Lösung gibt, den Migrationsverlauf der Datenbank eines Genie-Cloud-Projekts einsehen und deine MCP-Integrationen verwalten — alles über natürliche Sprache.
