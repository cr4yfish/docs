...
Auf der Einstellungsseite **Allgemein** bearbeitet ein Eigentümer oder Admin den Workspace selbst: Name, Beschreibung, ein Logo und eine Akzentfarbe — gemeinsam gespeichert und überall sichtbar, wo der Workspace benannt wird, vom Umschalter in der Seitenleiste bis zum Drawer auf dem Mobilgerät. Lässt du eines davon leer, fällt das Badge wie bisher auf den Anfangsbuchstaben des Workspace auf einem Standardhintergrund zurück.

<Tip>
Lass das stattdessen von Genie AI erledigen — *„setze unser Workspace-Logo auf dieses Bild"* oder *„mach unsere Akzentfarbe ein dunkles Grün"* — über den **Genie AI fragen**-Button auf der Seite „Allgemein".
</Tip>
