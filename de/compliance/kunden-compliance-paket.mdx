...
| 10 | **OpenAI** | LLM-Inferenz, Default-Proxy-Upstream für Kunden-Edge-Functions. Zero-Data-Retention-Vereinbarung vorhanden. ⚠️ **Compliance-Hinweis:** Verarbeitung findet in den USA statt; keine EU-Region verfügbar. Für Teams-Kunden mit strikten EU-Residenzanforderungen empfehlen wir den Wechsel auf Anthropic via Bedrock oder Google Vertex AI (EU). | Prompts und Completions | US (SCC) | SOC 2 Type II |
...
| 14 | **Hugging Face** | Inferenz-Proxy-Ziel für Kunden-ML-Features. Nutzung ist optional und wird ausschließlich aktiviert, wenn der Nutzer dies explizit konfiguriert. | Prompts / Eingaben aus Kunden-Edge-Functions | US (SCC); EU-Endpoint wo verfügbar | SOC 2 Type II |
