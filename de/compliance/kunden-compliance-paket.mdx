...
| --- | --- | --- | --- | --- | --- |
| 1 | **Unsplash** | Bildersuche im In-App-Asset-Picker. Read-only; es werden grundsätzlich keine produktiven Kundendaten gespeichert. Suchstrings können personenbezogen sein und werden ausschließlich für die Suchanfrage an Unsplash übergeben. | Suchstring | US (Read-only Public API) | n/a |
