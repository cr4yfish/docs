...
The workspace AI can create and update projects, manage members, query credit usage, answer pricing questions, search past conversations, check whether a bug you describe has a known fix, review a Genie Cloud project's database migration history, and manage your MCP integrations — all through natural language.
