...
Every workspace includes the **Genie AI** tab — a persistent AI assistant scoped to your workspace. Click the **Genie AI** button in the sidebar or open it from the workspace home to start a conversation. You can ask questions about your projects, explore ideas, or continue a previous thread.

Conversations are saved automatically and appear in the Genie AI panel the next time you open it. The assistant has access to your workspace context — project names, recent activity, member list — so it can answer questions like *"Which of my projects was updated most recently?"* or *"Summarise the last week of activity."*

<Tip>
The Genie AI panel is also available from any project page. Use it to ask questions that span the whole workspace without leaving the project you are working on.
</Tip>

## Collaboration

When multiple team members open the same project, only one person can send prompts at a time. Genie shows a banner with the active editor's name and keeps your prompt input ready to use as soon as they finish. The handover happens automatically — no manual steps required.

## Related pages

- [Workspace members](/workspaces/members)
