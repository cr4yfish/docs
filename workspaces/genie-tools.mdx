...
| Form | Fields that run an action when submitted — add a row, update one, anything you describe. A field can also be a file upload, kept just for that one submission or filed straight into your [knowledge base](/workspaces/overview#knowledge-base) |
