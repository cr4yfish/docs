...
Genie AI shows the tool working right in the chat as it builds it — a live table, a working form — not just a description of what it did. Once you're happy with it, it's saved and appears on the **Tools** page for anyone in the workspace to open.
...
| Form | Fields that run an action when submitted — add a row, update one, anything you describe |
...
| Rows per workspace table | 10,000 |
