...
<Note>
Looking to message Genie from WhatsApp, Slack, or Microsoft Teams instead? That's a different kind of connection, managed from the same **Integrations** page — see [Genie on WhatsApp, Slack, and Teams](/workspaces/chat-channels).
</Note>
...
| **Google Drive** | `https://www.googleapis.com/drive/v3` | HTTP | OAuth2, per member |
...
<CardGroup cols={2}>
  <Card title="Genie on WhatsApp, Slack, and Teams" icon="message-circle" href="/workspaces/chat-channels">
    Message Genie directly from your phone or team chat.
  </Card>
  <Card title="Genie MCP Server" icon="server" href="/workspaces/mcp-api">
