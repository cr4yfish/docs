...
The Genie MCP Server provides tools across ten categories.
...
| Tool | What it does |
|---|---|
| `get_workspace_info` | Owner, name, member count, settings, and creation date |
| `list_workspace_members` | Members with roles, join dates, email addresses, and display names |
